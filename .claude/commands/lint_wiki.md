...
8. **Separation-of-concerns violations** — project conclusions, recommendations,
   or our own test results in wiki pages. Red flags: "for this app", "for this
   project", "recommended", "our app/code/results", a chosen target device.
   Conclusions belong in `docs/decisions.md`; a wiki page may carry a one-line
